...
```{r}
ggplot(inspection_data, aes(x=Time_refuge, y=N_inpsections, color=factor(Group_size))) +
  geom_point()
...
inspection_model <- cmdstan_model("mod_n_inspections--new.stan")
...
ref_inspection_model <- cmdstan_model("mod_n_inspections--new.stan")
